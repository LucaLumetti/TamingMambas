...
def get_ultralight_vm_unet_2d_from_plans(
    ...
    segmentation_network_class_name = 'UltraLight_VM_UNet'
    network_class = UltraLight_VM_UNet
    kwargs = {
        'UltraLight_VM_UNet': {
            'conv_bias': True,
    ...
    model = network_class(
        num_classes=label_manager.num_segmentation_heads, input_channels=num_input_channels, c_list=[8,16,24,32,48,64],
                split_att='fc', bridge=True
    )
