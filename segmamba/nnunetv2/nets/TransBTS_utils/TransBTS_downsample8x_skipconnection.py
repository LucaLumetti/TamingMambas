...
from nnunetv2.nets.TransBTS_utils.Transformer import TransformerModel
from nnunetv2.nets.TransBTS_utils.PositionalEncoding import FixedPositionalEncoding,LearnedPositionalEncoding
from nnunetv2.nets.TransBTS_utils.Unet_skipconnection import Unet
...
def get_TransBTS_3d_from_plans(
    ...
    model = BTS(
                    img_dim=configuration_manager.patch_size[0], # 128
                    patch_dim=8,
