...
from nnunetv2.nets.nnFormer import nnFormer, SegmentationNetwork
...
class nnUNetTrainernnFormer(nnUNetTrainer):
    """
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True, device: torch.device = torch.device('cuda')):
        ...
        self.load_pretrain_weight=False # TODO: era a true, ma non ho capito da dove arrivano quei pre-trained weights. Sono scaricabili da github
